...
I have no relation with MyClickWinners. I am interested in the workings of it. 
These FAQ contain questions I sent to MyClickWinners and the answers I received.
These answers I copy literally, except for some typo's that I fix and
replacing symbols like the euro sign for the word 'euro' (put after the value).
But it cannot be guaranteed I did not modify these answers beyond this :-)
...
This depends on if you quit MyClickWinners:

 * If you quit MyClickWinners: you can continue clicking until the Winners saturate, then you can transfer your BankWallet to your personal bank account [2,5]. Note that [7] states something differently
 * If you do not replenish your ClickCard but stay a member of MyClickWinners: You have invested in a Winner, without success. You cannot get the Winners back. You can get access your ShopWallet and BankWallet [4,5]
...
[5] Answer by Support Team MyClickWinners, sent at December 3rd 2015 8:42:

```
In uw eerste mailbericht heb ik verwezen naar de procedure die te maken
heeft met een opzegging. Hiervoor dient een klant een maand voor afloop
van de ClickCard aan te geven te willen stoppen. In dat geval kan men
doorklikken om de volle winst op een Winner te ontvangen. Deze procedure
staat omschreven in de algemene voorwaarden (die men verplicht aanklikt
voor verkoop). Het plaatsen in de FAQ garandeert ons niet dat
de klant er ook van de hoogte had kunnen zijn.

In de tweede mail / reactie heb ik uw vraag niet opgevat als een
opzegging, maar het niet vervangen van een ClickCard. De Winner zelf
vertegenwoordigt een waarde en geen opeisbaar tegoed. Dit staat vermeld
in uw BankWallet en ShopWallet. Wanneer een ClickCard niet wordt
vervangen, kan er ook niet worden geklikt. En dus zal er ook geen
winstbjschriving plaatsvinden. U heeft dus ook niet de volledige
inleg+winst over uw Winner teruggekregen. Op dat moment heeft u twee
keuzes:

*  U kiest ervoor om het account op te zeggen. U hoeft geen ClickCard te
vervangen, maar zult moeten blijven klikken om het volle rendement over
de Winnenrs te behalen.

*  U kiest ervoor om niet meer te klikken en neemt genoegen met het
openstaande saldo in uw BankWallet en ShopWallet. Dat is immers uw
opeisbare toegoed. Hierbij moet worden opgemaakt, dat u (bij niet
opzegging) minimaal 100,- euro dient over te boeken naar uw
bankrekening of Prepaid Credit Card. Bij opzegging kunt u het
openstaande saldo (binnen een maand) laten overboeken naar uw
bankrekening. De ShopWallet zult u zelf moeten legen door een aankoop te
doen.
```

[6] The `terms_and_conditions_cardholders.pdf` downloaded from the MyClickWinners website

```
Ending an account
A CardHolder of MyClickWinners may terminate the associated account which holds that:
 * The  notice  no  later  than  one  month  prior  to  the  closing  date  of  the  last  published  ClickCard  will  be 
communicated.
 * Through the customer proﬁ  le of the CardHolder.
 * Card Holder will receive a conﬁ rmation by e-mail.
 * The account is canceled by closing date of the last published ClickCard.
 * The outstanding balance of the BankWallet and ShopWallet submit before the end of this Contract by the 
CardHolder himself to be transferred and / or spent in the shop of MyClickWinners.
 * If  upon  removal  of  the  account  there  is  still  balance  present  in  the  BankWallet  or  ShopWallet  from  this 
account, the remaining balance goes soon after closure automatically to MyClickWinners.
```
...
## Why the email disclaimer?

According the MyClickWinners [2] this is to preotect the integrity of the customer
and could be considered a sign of professionalism. 

Note that according to Lidstone, 2015, an email disclaimer is useless outside of advocacy.

### References

[1] Email by Richel Bulderbeek, sent at Dec 2nd 2015 19:07:

```
Het viel mij op, dat onderaan een email staat:

This e-mail is intended for the addressee's eyes only. If you
are not the intended recipient, you are hereby kindly requested to
inform the sender of this. In view of the electronic nature of this
communication, MyClickWinners.com is neither liable for the proper and
complete transmission of the information contained therein nor for any
delay in its receipt. For information about MyClickWinners.com, direct
your browser to  <http://www.myclickwinners.com>
http://www.myclickwinners.com.

Dit voelt juist een *geen* openheid uitstralen. Hoe kan dit er dan toch =
onder staan?
```
...
```
Onze maildisclaimer zegt volgens mij niets over de mate van
transparantie of openheid van onze organisatie. Deze is juist bedoeld om
er voor te zorgen dat er geen misbruik kan worden gemaakt en dat de
bedoelde informatie ook bij de juiste geadresseerde moet uitkomen. Dit
ter becherming van de persoonlijke integriteit van onze klanten. Mijns
inziens duidt dit enkel op onze mate van professionaliteit.
```
...
## Would MyClickWinners mind this FAQ?

MyClickWinners does not stimulate me having this FAQ [1,2]
...
```
Ik zie dat de antwoorden op mijn vragen niet bij de FAQ ( =
https://www.myclickwinners.com/nl/meer-informatie/faq.html ) van de =
website komen. Waarom niet? Mocht dit een gedoe zijn, zou ik ook kunnen =
helpen door de mijn gestelde vragen en antwoorden op mijn website te =
zetten. Is het mogelijk de FAQ aan te vullen?
```

[2] Answer by Support Team MyClickWinners, sent at Dec 3rd 2015 9:14

```
Om de FAQ overzichtelijk te houden en slechts betrekking te geven op de
belangrijkste vragen die bij consumenten leven, zullen wij niet alle
mogelijke vragen en antwoorden hierin gaan plaatsen. Uw verzoek tot
opname van deze antwoorden moet ik (gebaseerd op uw enkel verzoek) dan
ook helaas afwijzen. Uw suggestie om vragen en antwoorden te plaatsen op
uw website wijs ik zeker van de hand. Daarbij kennen wij uw website niet
eens en bestaat er geen enkele officieele relatie die dit zou
rechtvaardgen.
```
...
## Are there any signs that MCW is a MLM-based pyramid scheme?
 ...
 * Sales pitch emphasizes recruiting: Disagree, but option is mentioned
 * Excessive earnings claims or promises of high returns in a short time period: Agree, there is a table in the presentation showing a calculation with a high return
 * Product is unproven and/or unfailry priced: Agree: what _is_ the product?
 * Buy-in required: Agree, ClickCard costs 60 euro per year
 * Vast majority of participants lose money: Unknown
 * No information of potential expenses (in writing): Undecided: there is no information about this, but they may be absent as well
 * Consumer complaints (from other regions or prioir waves): Unknown
 ...
 * [1] Bosley, Stacie, and Kim K. McKeage. "Multilevel Marketing Diffusion and the Risk of Pyramid Scheme Activity: The Case of Fortune Hi-Tech Marketing in Montana." American Marketing Association, 2015.
 * [2] Lidstone, Herrick K. "Email Disclaimers–A Worthwhile Endeavor or a Waste of Electronic Ink?." Available at SSRN 2656466 (2015)